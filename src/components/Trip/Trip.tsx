...
const TripComponent = memo(({ trip }: ITripComponent) => {
  return (
      ...
      <div className={styles.tripInfoContainer}>
        <div className={styles.titleAndPriceContainer}>
          ...
          <div className={styles.priceContainer}>
            <div>За 1 час</div>
            <div className={styles.price}>от {trip.price} ₽</div>
          </div>
        </div>
        <div className={styles.locationAndDateContainer}>
          <div className={styles.location}>
            ...
            >
              <path
                d="M7.26758 19.0088C7.59717 19.5215 8.36621 19.5215 8.6958 19.0088C14.0425 11.3184 15.0312 10.5127 15.0312 7.65625C15.0312 3.77441 11.8818 0.625 8 0.625C4.08154 0.625 0.96875 3.77441 0.96875 7.65625C0.96875 10.5127 1.9209 11.3184 7.26758 19.0088Z"
                fill="#01B4A8"
              />
            </svg>
            {trip.location}
        ...
        <div className={styles.cargoType}>
          ...
          <div className={styles.cargoTypeItems}>
            {trip.cargoType.slice(0, 3).join(", ")}
            {trip.cargoType.slice(3).length > 0 ? (
              <>
                {" и"}
                <div className={styles.anotherType}>
                  еще {trip.cargoType.slice(3).length} типов
                </div>
              </>
            ) : (
              <></>
